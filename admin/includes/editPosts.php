...
//                           move_uploaded_file($postImageTemp, $location);  [postImage = '{$location}']
      
      
$query = "UPDATE posts SET postCategoryId = '{$postCategoryId}', postTitle = '{$postTitle}', postAuthor = '{$postAuthor}', postDate =  now(), postContent = '{$postContent}', postTags = '{$postTags}', postComCount = '{$postComCount}', postStatus = '{$postStatus}' WHERE postId = {$postId}";
